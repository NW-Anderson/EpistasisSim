...
#                          "stabilizing" # 5
#                          ), each = 1000)
fitnessFunction <- rep(c(1,1,1,2), each = 1000)
a <- rep(c(8,-8,abcEst,0), each = 1000)
s <- rep(c(0,0,0,0), each = 1000)
r <- rep(c(0,0,0,0), each = 1000)
b <- rep(c(0,0,0,0), each = 1000)
mu <- rep(c(0,0,0,0), each = 1000)
std <- rep(c(0,0,0,0), each = 1000)
seed <- sample(1:2^15, length(fitnessFunction))
